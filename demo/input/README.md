...
`contarom/reddit-comments.json` is a privacy reviewed sample from an Apify run completed on 28 August 2026. The actor returned 123 records, including 117 comments from six verified Romanian threads. The collector removed identity fields and unsafe records. Twenty one anonymous comments were retained for the demo.
